...
export default function MapPage() {
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 overflow-hidden">
      {/* TopAppBar */}
      <nav className="fixed top-0 w-full z-50 flex justify-between items-center px-6 py-3 bg-slate-950/80 backdrop-blur-md border-b border-slate-800 shadow-2xl shadow-violet-500/10 font-headline antialiased">
        <div className="flex items-center gap-8">
          <span className="text-xl font-bold tracking-tighter text-violet-400">Dycery Terminal</span>
          <div className="hidden md:flex items-center gap-6">
            ...
            <span className="text-violet-400 font-bold border-b-2 border-violet-500 pb-1 cursor-default">Round: 1</span>
      ...
      <aside className="fixed left-0 top-0 h-full w-64 z-40 flex flex-col pt-16 pb-8 bg-slate-950 border-r border-slate-800 font-headline text-sm">
        <div className="px-6 py-4 mb-4">
          <div className="text-lg font-black text-violet-400">Dycery Terminal</div>
        ...
        <nav className="flex-1 space-y-1">
          ...
          <div className="flex items-center gap-3 bg-violet-500/10 text-violet-400 border-r-4 border-violet-500 px-4 py-3 cursor-pointer">
        ...
        <div className="px-6 mt-auto">
          <div className="p-3 bg-zinc-800 rounded-lg border border-zinc-700/30">
            <div className="text-[10px] text-amber-400 font-bold mb-1">SYSTEM STATUS</div>
      ...
      {/* Main Content Area */}
      <main className="ml-64 mt-14 h-[calc(100vh-3.5rem)] relative overflow-hidden bg-slate-950">
            ...
            <div className="w-full h-full relative">
              ...
              <div className="absolute top-[40%] left-[30%] group">
                <div className="relative flex items-center justify-center">
                  ...
                  <div className="w-8 h-8 bg-zinc-600 border-2 border-amber-400 rounded-full flex items-center justify-center text-amber-400 shadow-[0_0_15px_rgba(251,191,36,0.5)] cursor-pointer z-10 transition-transform hover:scale-110">
                    <span className="material-symbols-outlined text-sm" style={{ fontVariationSettings: "'FILL' 1" }}>home</span>
                  </div>
                </div>
                <div className="absolute left-10 top-0 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-20 w-48 bg-slate-900/95 backdrop-blur-md border border-amber-400/50 p-3 rounded shadow-2xl">
                  <div className="text-amber-400 font-headline font-bold text-sm mb-1 uppercase tracking-wider">Oakheart Village</div>
              ...
              <div className="absolute top-[25%] left-[65%] group">
                <div className="relative flex items-center justify-center">
                  <div className="w-8 h-8 bg-zinc-600 border-2 border-violet-400 rounded-full flex items-center justify-center text-violet-400 shadow-[0_0_15px_rgba(167,139,250,0.5)] cursor-pointer z-10 transition-transform hover:scale-110">
                    <span className="material-symbols-outlined text-sm" style={{ fontVariationSettings: "'FILL' 1" }}>account_balance</span>
                  </div>
                </div>
                <div className="absolute left-10 top-0 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-20 w-48 bg-slate-900/95 backdrop-blur-md border border-violet-400/50 p-3 rounded shadow-2xl">
                  <div className="text-violet-400 font-headline font-bold text-sm mb-1 uppercase tracking-wider">Eldritch Spire</div>
                  <div className="grid grid-cols-2 gap-2 text-[10px]">
                    <span className="text-slate-500">Environment</span>
              ...
              <div className="absolute top-[70%] left-[45%] group">
                <div className="relative flex items-center justify-center">
                  <div className="w-8 h-8 bg-zinc-600 border-2 border-red-400 rounded-full flex items-center justify-center text-red-400 shadow-[0_0_15px_rgba(248,113,113,0.5)] cursor-pointer z-10 transition-transform hover:scale-110">
                    <span className="material-symbols-outlined text-sm" style={{ fontVariationSettings: "'FILL' 1" }}>landscape</span>
                  </div>
                </div>
                <div className="absolute left-10 top-0 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-20 w-48 bg-slate-900/95 backdrop-blur-md border border-red-400/50 p-3 rounded shadow-2xl">
                  <div className="text-red-400 font-headline font-bold text-sm mb-1 uppercase tracking-wider">The Void Maw</div>
                  <div className="grid grid-cols-2 gap-2 text-[10px]">
                    <span className="text-slate-500">Environment</span>
              ...
              <div className="absolute top-[60%] left-[80%] group">
                <div className="relative flex items-center justify-center">
                  <div className="absolute w-16 h-16 border-2 border-red-400/20 rounded-full animate-pulse"></div>
                  <div className="w-10 h-10 bg-zinc-600 border-2 border-red-400 rounded flex items-center justify-center text-red-400 shadow-[0_0_25px_rgba(239,68,68,0.6)] cursor-pointer z-10 transition-transform hover:scale-125 rotate-45">
                    <span className="material-symbols-outlined text-lg -rotate-45" style={{ fontVariationSettings: "'FILL' 1" }}>skull</span>
                  </div>
                </div>
                <div className="absolute right-12 top-0 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-20 w-56 bg-slate-950/98 backdrop-blur-xl border border-red-400 p-4 rounded shadow-[0_0_40px_rgba(0,0,0,0.8)]">
                  <div className="text-red-400 font-headline font-black text-base mb-2 uppercase tracking-tighter">Dragon's Reach</div>
                  <div className="space-y-3">
                    ...
                    <div className="pt-2 border-t border-slate-800">
                      ...
                      <span className="text-sm font-bold text-amber-400">Ignis the Scourge</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="absolute top-6 left-6 z-10">
          <div className="bg-slate-950/90 backdrop-blur-md border-l-4 border-violet-400 p-4 shadow-2xl">
            <h1 className="font-headline text-2xl font-black text-violet-400 tracking-tight leading-none">THE WHISPERING WOODS</h1>
        ...
        <div className="absolute bottom-6 left-6 z-10 w-80">
          <div className="bg-slate-950/90 backdrop-blur-md border border-slate-800 rounded p-4 shadow-2xl">
            <div className="flex justify-between items-center mb-4 border-b border-slate-800 pb-2">
              <span className="font-headline font-bold text-xs text-amber-400 flex items-center gap-2 uppercase tracking-widest">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-end">
                <div>
                  ...
                  <div className="text-xl font-headline font-bold text-slate-200">14.2 km</div>
                </div>
                <div className="text-right">
                  <div className="text-[10px] text-slate-500 uppercase font-bold">Est. Time</div>
                  <div className="text-xl font-headline font-bold text-violet-400">6h 15m</div>
                </div>
              </div>
              <div className="p-3 bg-slate-900 rounded border border-zinc-700/20">
                <div className="flex items-center gap-3">
                  <span className="material-symbols-outlined text-amber-400 text-2xl">thunderstorm</span>
                  <div>
          ...
          <div className="bg-slate-950/90 backdrop-blur-md border border-slate-800 rounded p-4 shadow-2xl">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-3 text-xs text-slate-300">
                <div className="w-4 h-4 border border-amber-400 rounded-full flex items-center justify-center text-[10px] text-amber-400">
                  <span className="material-symbols-outlined text-[10px]" style={{ fontVariationSettings: "'FILL' 1" }}>home</span>
                </div>
                <span>Settlement</span>
              </div>
              <div className="flex items-center gap-3 text-xs text-slate-300">
                <div className="w-4 h-4 border border-violet-400 rounded-full flex items-center justify-center text-[10px] text-violet-400">
              ...
              <div className="flex items-center gap-3 text-xs text-slate-300">
                <div className="w-4 h-4 border border-red-400 rounded-full flex items-center justify-center text-[10px] text-red-400">
              ...
              <div className="flex items-center gap-3 text-xs text-slate-300">
                <div className="w-4 h-4 bg-red-400/20 border border-red-400 rounded rotate-45 flex items-center justify-center text-[10px] text-red-400">
        ...
        <div className="absolute top-6 right-6 z-10 flex flex-col gap-2">
          ...
          <div className="bg-slate-950/90 border border-slate-800 w-12 h-12 flex items-center justify-center text-violet-400 shadow-xl rounded">
        ...
        <div className="absolute bottom-0 w-full z-20 bg-slate-950/95 border-t border-slate-800 py-1 px-4 flex items-center justify-between text-[10px] font-mono tracking-tighter">
          ...
          <div className="flex gap-4">
            <span className="text-violet-400 font-bold">PARTY POSITION: 30.0 / 40.0</span>
            <span className="text-slate-500">ENTITY COUNT: <span className="text-amber-400">42 DETECTED</span></span>
          </div>
          <div className="flex gap-4 items-center">
            <div className="flex gap-1">
              <div className="w-1 h-3 bg-violet-400"></div>
              <div className="w-1 h-3 bg-violet-400/60"></div>
              <div className="w-1 h-3 bg-violet-400/30"></div>
